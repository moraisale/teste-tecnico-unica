...
export const BuildYourFutureSession = () => {
  return (
    <div className="flex flex-col w-full bg-white dark:bg-black justify-center items-center text-center px-6 xl:px-[124px]">
      <div className="flex flex-col xl:flex-row xl:text-start items-center xl:items-end">
        <div className="flex flex-col ">
          <p className="text-xl lg:text-[32px] text-black dark:text-white pt-[84px] pb-8 ">
