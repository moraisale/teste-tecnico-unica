...
export const DepoimentCard = ({depoiment}: IDepoimentCard) => {
  return (
    <div
      className={`flex flex-col justify-center items-center xl:w-[384px] w-[300px] rounded-md shadow-[10px_10px_#000000]/20  bg-[#A68BFF66]/40 h-full min-h-[416.41px] gap-[51.66px] px-[38.65px]`}
    >
